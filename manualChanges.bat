...
:badFiles
	echo This command isn't configured yet, sorry
...
:services
	...
	#Disabling Simple TCP/IP
	sc stop simptcp
	sc config simptcp start= disabled

	#Enabling Update Service
	sc start wuauserv
	...
	#Disabling UPNP Device Host
	sc stop upnphost
	sc config upnphost start= disabled

	#Enabling Windows Event Collector
	sc enable Wecsvc
	sc config Wecsvc start= auto

	#Enabling Windows Event Log
	sc enable Eventlog
